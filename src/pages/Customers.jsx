  ...
  return (
    <div>
      ...
      <div className="flex gap-4 mb-6">
        ...
        <StatCard label="Active this month" value={active} badge="Waiting" badgeColor="orange" />
        <StatCard label="New this month" value={newThisMonth} badge="Active" badgeColor="green" />
                ...
                <tr key={customer.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                  <td className="table-cell">
                    <div className="flex items-center gap-3">
                      <img src={customer.avatar} alt="" className="w-9 h-9 rounded-full object-cover" />
                      <div>
                  ...
                  <td className="table-cell text-gray-500">{customer.joined}</td>
                  <td className="table-cell text-gray-700">{customer.bookings}</td>
                  <td className="table-cell font-semibold text-gray-900">{customer.totalSpent}</td>
                  <td className="table-cell text-gray-500">{customer.lastActive}</td>
                  <td className="table-cell">
                  ...
                  <td className="table-cell">
                    <div className="flex items-center gap-2">
                      ...
                      {customer.status === 'active' ? (
                        ...
                        <button
                          onClick={() => handleUnban(customer.id, customer.name)}
